...
def train_worker(args):
    ...
    set_random_seeds(42 + process_id)
    ...
    # scheduler = ReduceLROnPlateau(optimizer, 'min', factor=0.1, patience=20)  # Temporarily disabled
    ...
    for epoch in range(EPOCHS):
        ...
        # scheduler.step(avg_val_loss)  # Temporarily disabled
        ...
        # if epochs_no_improve > PATIENCE:  # Early stopping temporarily disabled
        #     break  # Early stopping temporarily disabled

        current_lr = optimizer.param_groups[0]['lr']  # Temporarily disabled
        if current_lr < MIN_LR:  # Temporarily disabled
